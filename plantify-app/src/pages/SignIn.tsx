    ...
    >
      ...
      <div className="flex justify-center items-center px-4 py-6">
        <div className="bg-white bg-opacity-70 p-6 md:p-4 rounded-lg shadow-lg w-full max-w-md">
          <h1 className="text-2xl md:text-4xl font-bold text-green-700 text-center mb-4">
            <img src={platifyLogo} alt="Logo" className="w-24 md:w-36 mx-auto" />
          </h1>
          <form onSubmit={handleSubmit}  className="space-y-3">
            ...
            <div className="text-center mt-4">
              <button
                className="w-full bg-gray-400 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-opacity-50"
              >
                Criar Conta
              </button>
            </div>
